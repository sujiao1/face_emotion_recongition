...
CK_train_path = 'datasets/CK+_renew/CK+_re_merge/test'
...
def emotion_label(emotion_path):
    anger_path = os.path.join('%s/%s' % (emotion_path, 'anger'))         # train-450        1350   re:612  1836 2448           val-162  297
    contempt_path = os.path.join('%s/%s' % (emotion_path, 'contempt'))   # train-180  480   1440   re:252  1260 2268           val-72   192
    disgust_path = os.path.join('%s/%s' % (emotion_path, 'disgust'))     # train-630        1890   re:846  2538 2538 1692 2217 val-216  216
    fear_path = os.path.join('%s/%s' % (emotion_path, 'fear'))           # train-270   495  1485   re:360  1800 2160           val-90   240
    happiness_path = os.path.join('%s/%s' % (emotion_path, 'happiness')) # train-720        2160   re:972  2916 2916 1944      val-252  252
    neutral_path = os.path.join('%s/%s' % (emotion_path, 'neutral'))     # train-6318  1053 3159   re:1053 3159 3159 2106      val-354  354
    sadness_path = os.path.join('%s/%s' % (emotion_path, 'sadness'))     # train-288   528  1584   re:378  1890 2268           val-90   240
    surprise_path = os.path.join('%s/%s' % (emotion_path, 'surprise'))   # train-882        2646   re:1188 3564 3564 2376      val-306  306
    ...
    img_label_path = os.path.join('datasets/img_label_data', 'CK+_test128_K_data.h5')
